 ...
 *
 */
public class Speed_CachePolicy implements CachePolicy {
	...
	public CacheType selectCacheLevel(Parameter parametro,
		...
		PriorityQueue<PriorityQueueNode> cacheLevels = new PriorityQueue<Speed_CachePolicy.PriorityQueueNode>(
				3);
