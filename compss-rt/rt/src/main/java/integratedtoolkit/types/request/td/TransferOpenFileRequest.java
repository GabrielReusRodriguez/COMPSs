...
/**
 * The TransferOpenFileRequest represents a request to transfer some file version 
 * located in a worker to the master to be opened during the execution
 */
public class TransferOpenFileRequest extends TDRequest {
     ...
     */
    public TransferOpenFileRequest(DataAccessId faId, Location location, Semaphore sem) {
        super(TDRequestType.TRANSFER_OPEN_FILE);
        this.faId = faId;
