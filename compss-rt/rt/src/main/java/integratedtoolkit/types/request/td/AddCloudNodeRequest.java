...
public class AddCloudNodeRequest extends TDRequest {
     ...
     * 
     */
    public AddCloudNodeRequest(String name, String provider, ResourceRequest resourceRequest, int limitOfTasks, boolean check) {
     ...
     * creation
     * 
     * @param resourceRequest the new request description that originated the creation
     */
