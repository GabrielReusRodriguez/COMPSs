...
public class ResourceDescription {
    ...
    public float difference(ResourceDescription mr2) {
        int processor_dif = this.processorCPUCount - mr2.processorCPUCount;
        float memory_dif = this.memoryPhysicalSize - mr2.memoryPhysicalSize;
        return processor_dif * 100 + memory_dif;
    }

    /* returns -1 if they're incompatible
     * returns 0 rc2=this
     * returns 1 if this>rc2
     * returns 2 if rc2>this
     */
    public int into(ResourceDescription rc2) {
        ...
        if (this.processorCPUCount == rc2.processorCPUCount) {
            if (this.processorSpeed == rc2.processorSpeed) {
                if (this.memoryPhysicalSize == rc2.memoryPhysicalSize) {
                    if (this.memoryAccessTime == rc2.memoryAccessTime) {
                        if (this.memorySTR == rc2.memorySTR) {
                            if (this.storageElemSize == rc2.storageElemSize) {
                                if (this.storageElemAccessTime == rc2.storageElemAccessTime) {
                                    return 0;
                                } else if (this.storageElemAccessTime < rc2.storageElemAccessTime) {
                            ...
                            } else if (this.storageElemSize > rc2.storageElemSize) {
                                if ((this.storageElemAccessTime <= rc2.storageElemAccessTime)
                        ...
                        } else if (this.memorySTR > rc2.memorySTR) {
                            if ((this.storageElemSize >= rc2.storageElemSize)
                    ...
                    } else if (this.memoryAccessTime < rc2.memoryAccessTime) {
                        if ((this.memorySTR >= rc2.memorySTR)
                ...
                } else if (this.memoryPhysicalSize > rc2.memoryPhysicalSize) {
                    if ((this.memoryAccessTime <= rc2.memoryVirtualSize)
            ...
            } else if (this.processorSpeed > rc2.processorSpeed) {
                if ((this.memoryPhysicalSize >= rc2.memoryPhysicalSize)
                        && (this.memoryAccessTime <= rc2.memoryVirtualSize)
                        && (this.memorySTR >= rc2.memorySTR)
                        && (this.storageElemSize >= rc2.storageElemSize)
                        && (this.storageElemAccessTime <= rc2.storageElemAccessTime)
                        && (this.storageElemSTR >= rc2.storageElemSTR)) {
        ...
        } else if (this.processorCPUCount > rc2.processorCPUCount) {
