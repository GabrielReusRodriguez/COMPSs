...
public class DataInfo {
    ...
    public LinkedList<DataInstanceId> getAllDataInstances() {
        LinkedList<DataInstanceId> renamings = new LinkedList();
        ...
        switch (mode) {
            case R:
                ...
                if (debug) {
                    logger.debug("Access:");
                    logger.debug("  * Type: R");
                    logger.debug("  * Read Datum: d" + daId.getDataId() + "v" + ((RAccessId) daId).getRVersionId());
                }
                break;
            ...
            case W:
                ...
                if (debug) {
                    logger.debug("Access:");
                    logger.debug("  * Type: W");
                    logger.debug("  * Write Datum: d" + daId.getDataId() + "v" + ((WAccessId) daId).getWVersionId());
                }
                break;
            ...
            case RW:
                ...
                if (debug) {
                    ...
                    logger.debug("  * Read Datum: d" + daId.getDataId() + "v" + ((RWAccessId) daId).getRVersionId());
                    logger.debug("  * Write Datum: d" + daId.getDataId() + "v" + ((RWAccessId) daId).getWVersionId());
                }
                break;
        }
        return daId;
