...
public class VM implements Comparable<VM> {
    ...
    public VM(String envId, String ip, String type, String image, int placement) {
        this.envId = envId;
        this.ip = ip;
    ...
    public String toString() {
        return "VM " + envId + " (ip = " + ip + ", start time = " + startTime + ", image = " + image + ", type = " + type + ", placement = " + placement + ", to delete = " + toDelete + ")";
    }
